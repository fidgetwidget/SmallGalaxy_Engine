...
namespace SmallGalaxy_Engine.Primitives
{
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        const int DEFAULT_BUFFER_SIZE = 500;
        ...
        // positionInBuffer.
        VertexPositionColor[] _vertices = new VertexPositionColor[DEFAULT_BUFFER_SIZE];
        ...
        #endregion // Constatns and Fields

        public Matrix Projection { get { return _basicEffect.Projection; } set { _basicEffect.Projection = value; } }
        ...
        public void Begin(PrimitiveType primitiveType)
        {
            ...
            this._numVertsPerPrimitive = NumVertsPerPrimitive(primitiveType);
        ...
        private void Flush()
        {
            ...
            _device.DrawUserPrimitives<VertexPositionColor>(_primitiveType, _vertices, 0,
                primitiveCount);
