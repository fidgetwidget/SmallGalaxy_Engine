...
namespace SmallGalaxy_Engine.Debug
{
    ...
    public class DebugSystem
    {
        ...
        public SafeAreaDisplay SafeAreaDisplay { get; private set; }
        ...
        public SceneMangerUtil SceneMangerUtil { get; private set; }
#endif
        ...
        public static DebugSystem Initialize(Game game)
        {
            ...
            singletonInstance.SafeAreaDisplay = new SafeAreaDisplay(game);
            game.Components.Add(singletonInstance.SafeAreaDisplay);
...
#if WINDOWS
            singletonInstance.SceneMangerUtil = new SceneMangerUtil(game);
            game.Components.Add(singletonInstance.SceneMangerUtil);
#endif
